        ...
        <div class="col-lg-12">
          <div class="card">
            <!-- <div class="card-header"> -->
              <!-- <a href="javascript:void(0);" class="btn btn-success btn-sm float-right" data-toggle="modal" data-target="#formModal"><i class="fas fa-plus-circle"></i>
                New brand</a> -->
                <!-- <div class="row">
                        ...
                        <form id="forminfo" action="apps/type/do_type.php?action=save_type" method="POST" autocomplete="off">
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              <div class="form-group">
                                <label for="category" class="col-form-label">Type <span class="text-danger">*</span></label>
                              ...
                              <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-block"><i class="fas fa-check-circle"></i> Submit</button>
              ...
              <form action="apps/brand/do_brand.php?action=delete_all" id="frm" method="POST">
                ...
                ?>
                      <tr>
                        ...
                        <td><?php echo $type_txt[$value["type"]];?></td>
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <small><a class="dropdown-item brand-edit"
                                  href="javascript:void(0);" data-brand-id="<?php echo $value["id"];?>" data-brand-status="<?php echo $value["status"];?>" data-brand-name="<?php echo $value["name"];?>" data-brand-type="<?php echo $value["type"];?>"><i class="fas fa-edit" ></i>
                                  Edit</a></small>
